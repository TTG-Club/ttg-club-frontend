  ...
  return defineConfig({
    ...
    plugins: [
      checker({
        ...
        eslint: {
          lintCommand:
            'eslint "{**/*,*}.{cjs,js,ts,jsx,tsx,vue}" --cache --cache-strategy content --ignore-path .eslintignore',
          dev: {
            logLevel: ['error'],
          },
        },
        stylelint: {
          lintCommand:
            'stylelint "{**/*,*}.{css,scss,vue}" --cache --cache-strategy content --ignore-path .eslintignore',
          dev: {
            logLevel: ['error'],
          },
        },
