import { EObjectTypes } from '@/components/render/types/render.types';
...
interface IMarkupHeading2 extends IMarkupHeadingBase, IMarkupHeadingWithCollapse {
    level: 2;
    bg?: boolean;
    colored?: boolean;
    subtitle?: string;
...
export type TMarkupHeading = IMarkupHeading1 | IMarkupHeading2 | IMarkupHeading3;
