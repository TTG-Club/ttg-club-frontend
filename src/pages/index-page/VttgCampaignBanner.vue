...
<style lang="scss" scoped>
  .vttg-banner {
    ...
    &:hover {
      ...
      box-shadow:
        0 12px 30px -10px rgb(0 0 0 / 60%),
        0 0 24px -6px color-mix(in oklch, var(--vttg-gold) 25%, transparent);
  ...
  .vttg-btn {
    ...
    &.vttg-btn-primary {
      ...
      background-color: var(--vttg-gold) !important;
      border: 1px solid var(--vttg-gold) !important;
